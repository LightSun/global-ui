...
static inline std::vector<std::string> split_string(const std::string &s,
...
static inline bool ends_with(std::string const &str, std::string const &ending) {
...
static inline bool starts_with(std::string const &str, std::string const &ending) {
    if (ending.size() > str.size())
        return false;
    else
